...
<head>
    ...
    <title>PEA | <?= !empty($title)? $title: ''?></title>
...
<body>
    ...
    <div class="container-informations">
        ...
        <div class="content">
            ...
            <p>Après être passé par la case inscription, crée ta propre ligue et invite tous tes potes à l’aide d’un code. Une fois que tes potes t’auront rejoint tu pourras choisir des matchs sur lesquels pronostiquer. Tu pourras modifier ton choix jusqu’à 1 minute avant le coup d’envoi.</p>
            <p>Simple non ?</p>
